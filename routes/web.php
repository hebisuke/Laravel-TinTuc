...
Route::get('lienlac','PageController@getLienLac');
...
Route::get('nguoidung/sua/{id}','PageController@getSuaNguoiDung');
Route::post('nguoidung/sua/{id}','PageController@postSuaNguoiDung');
