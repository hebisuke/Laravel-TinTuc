<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                    <a href="#"><i class="fa fa fa-android fa-fw"></i>Tin Tức<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
            ...
            <li>
                    <a href="admin/slide/danhsach"><i class="fa fa-align-right fa-fw"></i>Slide<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
